...
################################################################################
  ...
  require_once('include/settings.inc.php');
	...
	if($task == 'send'){
		...
		$captcha_site_key	= isset($_POST['captcha_site_key']) ? prepare_input($_POST['captcha_site_key']) : '';
		$captcha_secret_key	= isset($_POST['captcha_secret_key']) ? prepare_input($_POST['captcha_secret_key']) : '';
		$install_type		= isset($_POST['install_type']) ? prepare_input($_POST['install_type']) : 'create';
		//Mail
		$mail_driver			= isset($_POST['mail_driver']) ? prepare_input($_POST['mail_driver']) : '';
		$mail_host				= isset($_POST['mail_host']) ? prepare_input($_POST['mail_host']) : '';
		$mail_port				= isset($_POST['mail_port']) ? prepare_input($_POST['mail_port']) : '';
		$mail_username		= isset($_POST['mail_username']) ? prepare_input($_POST['mail_username']) : '';
		$mail_password		= isset($_POST['mail_password']) ? prepare_input($_POST['mail_password']) : '';
		$mail_encryption	= isset($_POST['mail_encryption']) ? prepare_input($_POST['mail_encryption']) : '';
		...
		//	$error_msg = lang_key('alert_db_password_empty');
			...
			if(EI_MODE == 'demo'){
				if($database_host != 'localhost' || $database_name != 'dship' || $database_username != 'root' || $database_password != ''){ //Demo
			...
			if(empty($error_msg)){
				...
				$_SESSION['captcha_site_key'] = $captcha_site_key;
				$_SESSION['captcha_secret_key'] = $captcha_secret_key;
				//Mail
				$_SESSION['mail_driver'] = $mail_driver;
				...
				$_SESSION['mail_encryption'] = $mail_encryption;
		...
		$captcha_site_key			= isset($_SESSION['captcha_site_key']) ? $_SESSION['captcha_site_key'] : '';
		$captcha_secret_key		= isset($_SESSION['captcha_secret_key']) ? $_SESSION['captcha_secret_key'] : '';
		$install_type					= isset($_SESSION['install_type']) ? $_SESSION['install_type'] : 'create';
		// Mail
		$mail_driver					= isset($_SESSION['mail_driver']) ? $_SESSION['mail_driver'] : '';
		...
		$mail_encryption			= isset($_SESSION['mail_encryption']) ? $_SESSION['mail_encryption'] : '';
...
<head>
    ...
    <meta name="author" content="Complete Laravel Dropshipping Script">
    <meta name="generator" content="Complete Laravel Dropshipping Script Installer>
	...
	<div id="content">
		...
		<div class="central-part">
			...
			<tr>
				...
				<td>
					<input required type="text" class="form_text" name="database_host" id="database_host" size="30" value="<?php echo $database_host; ?>" placeholder="<?php if(EI_MODE == 'demo') echo 'demo: localhost'; ?>" onfocus="textboxOnFocus('notes_host')" onblur="textboxOnBlur('notes_host')" />
				</td>
			...
			<tr>
				...
				<td>
					<input required type="text" class="form_text" name="database_name" id="database_name" size="30" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> value="<?php echo $database_name; ?>" placeholder="<?php if(EI_MODE == 'demo') echo 'demo: db_name'; ?>" onfocus="textboxOnFocus('notes_db_name')" onblur="textboxOnBlur('notes_db_name')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('database_username'); ?>: <span class="star">*</span></td>
				<td>
					<input required type="text" class="form_text" name="database_username" id="database_username" size="30" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> value="<?php echo $database_username; ?>" placeholder="<?php if(EI_MODE == 'demo') echo 'demo: test'; ?>" onfocus="textboxOnFocus('notes_db_user')" onblur="textboxOnBlur('notes_db_user')" />
				</td>
			</tr>
			<tr>
			...
			<hr /><br />
			<tr>
				<td nowrap>&nbsp;Captcha Site key:</td>
				<td>
					<input required type="text" class="form_text" name="captcha_site_key" id="captcha_site_key" size="30"
					value="<?php echo $captcha_site_key; ?>"
							<?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?>
							placeholder="<?php if(EI_MODE == 'demo') echo 'demo: test'; ?>"
						onfocus="textboxOnFocus('notes_db_captcha_site_key')" onblur="textboxOnBlur('notes_db_captcha_site_key')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;Captcha Secret key:</td>
				<td>
					<input required type="text" class="form_text" name="captcha_secret_key" id="captcha_secret_key" size="30"
					value="<?php echo $captcha_secret_key; ?>"
							<?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?>
							placeholder="<?php if(EI_MODE == 'demo') echo 'demo: test'; ?>"
						onfocus="textboxOnFocus('notes_db_captcha_secret_key')" onblur="textboxOnBlur('notes_db_captcha_secret_key')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;Mail SetUp:</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;Mail Driver:</td>
				<td>
					<input required type="text" class="form_text" name="mail_driver" id="mail_driver" size="30"
					value="smtp" onfocus="textboxOnFocus('notes_db_mail_driver')" onblur="textboxOnBlur('notes_db_mail_driver')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;Mail Host:</td>
				<td>
					<input required type="text" class="form_text" name="mail_host" id="mail_host" size="30"
					value="smtp.mailtrap.io" onfocus="textboxOnFocus('notes_db_mail_host')" onblur="textboxOnBlur('notes_db_mail_host')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;Mail Port:</td>
				<td>
					<input required type="text" class="form_text" name="mail_port" id="mail_port" size="30"
					value="2525" onfocus="textboxOnFocus('notes_db_mail_port')" onblur="textboxOnBlur('notes_db_mail_port')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;Mail Username:</td>
				<td>
					<input required type="text" class="form_text" name="mail_username" id="mail_username" size="30"
					value="9d600db5c48bfd" onfocus="textboxOnFocus('notes_db_mail_username')" onblur="textboxOnBlur('notes_db_mail_username')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;Mail Password:</td>
				<td>
					<input required type="text" class="form_text" name="mail_password" id="mail_password" size="30"
					value="2b050087a34f7f" onfocus="textboxOnFocus('notes_db_password')" onblur="textboxOnBlur('notes_db_password')" />
				</td>
			</tr>
			<tr>
				<td nowrap>&nbsp;Mail Encryption:</td>
				<td>
					<input required type="text" class="form_text" name="mail_encryption" id="mail_encryption" size="30"
					value="null" onfocus="textboxOnFocus('notes_db_mail_encryption')" onblur="textboxOnBlur('notes_db_mail_encryption')" />
				</td>
			</tr>
			<tr>
				<td colspan="2">

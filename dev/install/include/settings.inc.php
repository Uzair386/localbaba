<?php
 error_reporting(0);
    ...
    define('EI_PHP_MINIMUM_VERSION', '7.1.14');
    ...
    // define('EI_CONFIG_FILE_DIRECTORY', '../controller/');
    define('EI_CONFIG_FILE_DIRECTORY', '../laravel/');
    // *** config file name - output file with config parameters (database, username etc.)
    define('EI_CONFIG_FILE_NAME', '.env');
    ...
    define('EI_CONFIG_FILE_TEMPLATE', '.env');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'Complete Laravel Dropshipping Script');
    // *** version number of your application
    define('EI_APPLICATION_VERSION', 'v1.0.6');
    ...
    define('EI_POST_INSTALLATION_TEXT', 'Thank You!');

...
<html lang="en">
<head>
    <title>{{ __('messages.Account Control Panel') }}</title>
    ...
    {{-- <link rel="stylesheet" href="{{asset('app/bower_components/chartist/css/chartist.css')}}" type="text/css" media="all"> --}}
                                    ...
                                    <ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn"
                                        ...
                                        <li>
                                            <li>
                                                ...
                                                document.getElementById('logout-form').submit();"><i class="feather icon-log-out"></i>{{ __('messages.Logout') }} 
                                            </a>
                    ...
                    <nav class="pcoded-navbar">
                        <div class="nav-list">
                            <div class="pcoded-inner-navbar main-menu">
                                ...
                                <li class="">
                                    <a href="{{ route('account.user.profile') }}" class="waves-effect waves-dark">
                                ...
                                <li class="">
                                    <a href="{{ route('account.invoices') }}" class="waves-effect waves-dark">
                                        <span class="pcoded-micon">
                                ...
                                <li class="">
                                    <a href="{{ route('cart') }}" class="waves-effect waves-dark">
                                        <span class="pcoded-micon">
                                            <i class="fa fa-shopping-cart"></i>
                                        </span>
                                        <span class="pcoded-mtext">{{ __('messages.Cart') }}</span>
                                    </a>
                                </li>
                                    ...
                                    <li class="">
                                        <a  class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext">{{ __('messages.version') }} {{$_ENV['DEV_VERSION']}}</span>
                                        </a>
                                    </li>
                                    ...
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            <li class="breadcrumb-item">
                                                <a href="{{ url('/account') }}"><i class="feather icon-home"></i></a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="{{ url('/account') }}">{{ __('messages.Dashboard') }}</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

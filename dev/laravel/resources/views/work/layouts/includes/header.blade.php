...
<head>
    <title>{{ __('messages.Admin Control Panel') }}l</title>
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        <a href="{{ url('/work') }}">
                            <i class="fa fa-home"></i> {{ __('messages.Dashboard') }}
                        </a>
                        ...
                        <ul class="nav-left">
                            <li>
                                <a href="{{ url('/') }}" class="waves-effect waves-light">
                                    <i class="fa fa-globe"></i>{{ __('messages.Site') }}
                                </a>
                            </li>

                            <li>
                                <a href="#!" onclick="javascript:toggleFullScreen()" class="waves-effect waves-light">
                                    <i class="full-screen feather icon-maximize"></i>{{ __('messages.Fullscreen') }}
                                </a>
                            </li>
                        </ul>
                        <ul class="nav-right">
                                    ...
                                    <ul class="show-notification profile-notification dropdown-menu"
                                        ...
                                        <li>
                                            <a href="{{ route('work.admin.profile') }}">
                                                <i class="feather icon-user"></i>{{ __('messages.Profile') }}
                                            </a>
                                        </li>
                                        <li>
                                        <li>
                                            <a href="{{ url('/work/logout') }}" onclick="event.preventDefault();
                                                document.getElementById('logout-form').submit();"><i
                                                    class="feather icon-log-out"></i>{{ __('messages.Logout') }}
                                            </a>
                    ...
                    <nav class="pcoded-navbar">
                        <div class="nav-list">
                            <div class="pcoded-inner-navbar main-menu">
                                <div class="pcoded-navigation-label">{{ __('messages.Dashboard') }}</div>
                                <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <li class="">
                                        <a href="{{ route('work.admin.profile') }}" class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext">{{ __('messages.Profile') }}</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="pcoded-hasmenu">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext"> {{ __('messages.Products') }}</span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="{{ route('products') }}" class="waves-effect waves-dark">
                                                <span><i class="fa fa-list" aria-hidden="true"></i> {{ __('messages.Products') }}</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ route('work.product.create') }}"
                                                    class="waves-effect waves-dark">
                                                    <span><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ __('messages.Add Product') }}</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ route('categories') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-th-list" aria-hidden="true"></i> {{ __('messages.Categories') }}</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ route('variations') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-arrows-alt" aria-hidden="true"></i> {{ __('messages.Variations') }}</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ route('work.product.import') }}"
                                                    class="waves-effect waves-dark">
                                                <span><i class="fa fa-upload" aria-hidden="true"></i> {{ __('messages.Csv Import') }}</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ route('work.crawl.ebay') }}"
                                                    class="waves-effect waves-dark">
                                                    <span><i class="fa fa-magnet" aria-hidden="true"></i> {{ __('messages.Crawler') }} Ebay</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="pcoded-hasmenu">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext">{{ __('messages.Users') }}</span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="{{ route('users') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-users" aria-hidden="true"></i> {{ __('messages.Customers') }}</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ route('admins') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-user-secret" aria-hidden="true"></i> {{ __('messages.Admin') }}</span>
                                                </a>
                                            </li>
                                    ...
                                    <li class="pcoded-hasmenu">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext">{{ __('messages.Coupons') }}</span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                    ...
                                    <li class="">
                                        <a href="{{ route('work.suppliers') }}" class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext">{{ __('messages.Suppliers') }}</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="pcoded-hasmenu">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext">{{ __('messages.Finance') }}</span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                            ...
                                            <li class="">
                                                <a href="{{ route('work.income') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-usd" aria-hidden="true"></i> {{ __('messages.Income') }}</span>
                                                </a>
                                            </li>
                                    ...
                                    <li class="pcoded-hasmenu">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="fa fa-book"
                                                    aria-hidden="true"></i></span>
                                            <span class="pcoded-mtext">{{ __('messages.Blog & Pages') }}</span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="{{ route('work.posts') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-list" aria-hidden="true"></i> {{ __('messages.View Blogs') }}</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ route('work.pages') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-list" aria-hidden="true"></i> {{ __('messages.View Pages') }}</span>
                                                </a>
                                            </li>
                                    ...
                                    <li class="pcoded-hasmenu">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext">{{ __('messages.Settings') }}</span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="{{ route('work.slides') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-picture-o" aria-hidden="true"></i> {{ __('messages.Slider') }}</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ route('work.regex') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-code" aria-hidden="true"></i> {{ __('messages.Regex Test') }}</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ route('work.settings') }}" class="waves-effect waves-dark">
                                                    <span><i class="fa fa-wrench" aria-hidden="true"></i> {{ __('messages.Site Settings') }}</>
                                                </a>
                                            </li>
                                    ...
                                    <li class="">
                                        <a class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext">{{ __('messages.version') }}
                                    ...
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a
                                                    href="{{ url('/work') }}">{{ __('messages.Dashboard') }}</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

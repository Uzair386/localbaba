...
<div class="card">
  ...
  <div class="card-block">
    ...
    <hr>
    @endif
    <form action="{{route('work.post.store')}}" method="post" enctype="multipart/form-data">
      {{csrf_field()}}
      ...
      <div class="row">
        ...
        <div class="col-sm-8 col-lg-10">
          <div class="input-group">
            <input type="text" class="form-control fill" required name="title" placeholder="Name">
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-8 col-lg-10">
          <div class="input-group">
            <input id="image" class="form-control fill" name="image" required type="file">
          </div>
        </div>
      </div>
      <div class="row">
